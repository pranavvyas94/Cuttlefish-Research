...
static const long steps_per_mm_XY = 50;
static const long steps_per_mm_Z = 1600;
...
constexpr float MAX_VELOCITY_Z_mm = 5;
constexpr float MAX_ACCELERATION_X_mm = 20;  // 50 mm/s/s
constexpr float MAX_ACCELERATION_Y_mm = 20;  // 50 mm/s/s
constexpr float MAX_ACCELERATION_Z_mm = 10;   // 20 mm/s/s
static const long X_NEG_LIMIT_MM = -120;
static const long X_POS_LIMIT_MM = 120;
static const long Y_NEG_LIMIT_MM = -120;
static const long Y_POS_LIMIT_MM = 120;
static const long Z_NEG_LIMIT_MM = -10;
static const long Z_POS_LIMIT_MM = 10;
